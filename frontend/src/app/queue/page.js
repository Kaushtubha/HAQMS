                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div className="mb-6">
                    ...
                    {docInfo.calling ? (
                      <div className="bg-teal-500/10 border border-teal-500/30 p-6 rounded-2xl text-center">
                        <span className="block text-5xl font-black text-teal-600 dark:text-teal-400 animate-pulse">#{docInfo.calling.tokenNumber}</span>
                        <span className="block text-xs font-bold text-slate-400 uppercase mt-2">Patient: {docInfo.calling.patient?.name ?? 'Unknown'}</span>
                      </div>
                    ) : (
                  ...
                  <div>
                    ...
                    {docInfo.waiting.length > 0 ? (
                      ...
                      <span className="text-xs text-slate-400 italic">No upcoming patients in queue</span>
                    )}
                  </div>
                </div>
              </div>
